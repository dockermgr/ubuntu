...
# @@File             :  install.sh
# @@Description      :  docker installer script for ubuntu
...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/ubuntu"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="ubuntu"
APPDIR="$HOME/.local/share/srv/docker/ubuntu"
INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/ubuntu"
DATADIR="$HOME/.local/share/srv/docker/ubuntu/rootfs"
...
UBUNTU_USERNAME="${UBUNTU_USERNAME:-$DEFAULT_USERNAME}"
UBUNTU_PASSWORD="${UBUNTU_PASSWORD:-$DEFAULT_PASSWORD}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set container hostname and domain - Default ubuntu
CONTAINER_HOSTNAME="${CONTAINER_HOSTNAME:-$APPNAME}"
CONTAINER_DOMAINNAME="${CONTAINER_DOMAINNAME:-$HOSTNAME}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# URL to container image [docker pull URL]
HUB_IMAGE_URL="casjaysdevdocker/ubuntu"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
CONTAINER_USER_NAME="${UBUNTU_USERNAME:-}"
CONTAINER_USER_PASS="${UBUNTU_PASSWORD:-}"
...
SET_USER_NAME="${CONTAINER_USER_NAME:-$UBUNTU_USERNAME}"
SET_USER_PASS="${CONTAINER_USER_PASS:-$UBUNTU_PASSWORD}"
